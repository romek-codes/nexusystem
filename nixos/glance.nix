...
let
  ...
  customCss = pkgs.writeText "glance-custom.css" ''
    :root {
      --color-background: #${config.lib.stylix.colors.base00} !important;
    }
  '';
in
{
    ...
    glance = {
      ...
      settings = {
        theme = {
          ...
          custom-css-file = "/assets/glance-custom.css";
        };
        pages = [
          {
                    ...
                    groups = [
                      {
                        ...
                        links = [
                          ...
                          {
                            title = "Decodo";
                            url = "https://dashboard.decodo.com/residential-proxies/statistics";
                          }
                          {
                            title = "PostHog";
  ...
  systemd.services.glance.preStart = ''
    mkdir -p /var/lib/glance/assets
    cp ${customCss} /var/lib/glance/assets/glance-custom.css
    chmod 0644 /var/lib/glance/assets/glance-custom.css
  '';
}
