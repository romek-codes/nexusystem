...
- `docs/SERVER.md`: self-hosted server setup (Tailscale + NGINX).
- `docs/THEMES.md`: themes and how to create them.
- `docs/SCRIPTS.md`: available user scripts.
- `docs/KEYBINDINGS-HYPRLAND.md`: Hyprland keybindings.
...
Full list and usage: `docs/SCRIPTS.md`.
...
- `README.md` is autogenerated. Edit source at
  `./.github/assets/README_template.md` when needed.
